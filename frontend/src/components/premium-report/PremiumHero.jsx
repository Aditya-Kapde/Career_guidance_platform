...
const PremiumHero = ({ reportData }) => {
  return (
    <section className="relative min-h-[80vh] flex flex-col justify-center py-20 px-4 sm:px-6 lg:px-8 border-b border-gray-100 bg-gradient-to-br from-white to-gray-50 overflow-hidden">
      {/* Decorative background graphics */}
      <div className="absolute top-0 right-0 -mr-20 -mt-20 w-96 h-96 rounded-full bg-indigo-50 opacity-50 blur-3xl mix-blend-multiply pointer-events-none"></div>
      <div className="absolute bottom-0 left-0 -ml-20 -mb-20 w-72 h-72 rounded-full bg-emerald-50 opacity-50 blur-3xl mix-blend-multiply pointer-events-none"></div>
